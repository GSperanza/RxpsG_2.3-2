...
# here we define the RxpsG setAs() function
...
#'Function to control the attributes of an XPSSample.
#'
#'@param object XPSCoreLine object
#'
#'@docType methods
...
## =====================================================
# object == XPSresidualPlot

#'Function to plot data and the fit together with the residual difference.
#'
#'@param object XPSCoreLine object
#'
#'@docType methods
